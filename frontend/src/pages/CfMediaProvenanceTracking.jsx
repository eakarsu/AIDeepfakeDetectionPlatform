...
/**
 * Gap/CFS Feature Page: Media provenance tracking
 * Slug: media-provenance-tracking
 * Backend: /api/cf-media-provenance-tracking
 */
export default function MediaProvenanceTrackingPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-media-provenance-tracking', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Media provenance tracking</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Track media source and history; flag manipulated media.</p>
