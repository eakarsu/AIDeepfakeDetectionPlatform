...
/**
 * Gap/CFS Feature Page: Real-time media authentication
 * Slug: real-time-media-authentication
 * Backend: /api/cf-real-time-media-authentication
 */
export default function RealTimeMediaAuthenticationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-real-time-media-authentication', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Real-time media authentication</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Watermark generation and verification for media authenticity.</p>
