...
/**
 * Gap/CFS Feature Page: Explainability
 * Slug: explainability
 * Backend: /api/cf-explainability
 */
export default function ExplainabilityPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-explainability', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Explainability</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Show which facial regions/voice characteristics triggered deepfake detection.</p>
