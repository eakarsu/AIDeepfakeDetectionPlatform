...
/**
 * Gap/CFS Feature Page: Social media monitoring
 * Slug: social-media-monitoring
 * Backend: /api/cf-social-media-monitoring
 */
export default function SocialMediaMonitoringPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-social-media-monitoring', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Social media monitoring</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Auto-scan social platforms for deepfakes; alert on suspicious content.</p>
