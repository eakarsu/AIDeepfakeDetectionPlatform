...
/**
 * Gap/CFS Feature Page: Limited social-platform integration for automated detection.
 * Slug: limited-social-platform-integration-for-automated-detection
 * Backend: /api/gap-limited-social-platform-integration-for-automated-detection
 */
export default function LimitedSocialPlatformIntegrationForAutomatedDetectionPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited-social-platform-integration-for-automated-detection', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Limited social-platform integration for automated detection.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Limited social-platform integration for automated detection.</p>
